...
/*   Updated: 2025/09/20 20:54:17 by tkurukul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	if (hitpoints == 0)
	{
		std::cout << "ClapTrap " << name << " has passed away and cannot be attacked anymore :C!" << std::endl;
		return ;
	}
	if (amount > hitpoints)
		hitpoints = 0;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (hitpoints == 0)
	{
		std::cout << "ClapTrap " << name << " has passed away and cannot be repaired!" << std::endl;
		return ;
	}
	else if (energypoints == 0)
	{
...
void	ClapTrap::printStatus()
{
	...
	std::cout << "ClapTrap current hp:" << hitpoints << std::endl;
	std::cout << "ClapTrap current energy points:" << energypoints << std::endl;
	std::cout << "ClapTrap attack damage:" << attackdamage << std::endl;
}
